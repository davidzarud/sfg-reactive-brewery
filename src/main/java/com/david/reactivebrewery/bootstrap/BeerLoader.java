package com.david.reactivebrewery.bootstrap;

import com.david.reactivebrewery.repositories.BeerRepository;
    ...
    private synchronized void loadBeerObjects() {
        ...
        if (beerRepository.count().block() == 0) {
            ...
            beerRepository.save(Beer.builder()
                    ...
                    .quantityOnHand(random.nextInt(5000)).createdDate(LocalDateTime.now()).lastModifiedDate(LocalDateTime.now())
                    .build()).block();
